...
puts "Creating Users..."
User.create(username: 'Adreena', password: "test", acct_type: "player", total_points: 6)
User.create(username: 'Adrienne', password: "test", acct_type: "player", total_points: 4)
User.create(username: 'Arthur', password: "test", acct_type: "player", total_points: 2)
User.create(username: 'Brendan', password: "test", acct_type: "player", total_points: 9)
User.create(username: 'Carlos', password: "test", acct_type: "player", total_points: 32)
User.create(username: 'Dan', password: "test", acct_type: "admin", total_points: 5)
User.create(username: 'Darren', password: "test", acct_type: "player", total_points: 4)
User.create(username: 'Edward', password: "test", acct_type: "player", total_points: 11)
User.create(username: 'Greg', password: "test", acct_type: "player", total_points: 34)
User.create(username: 'Jack', password: "test", acct_type: "player", total_points: 9)
User.create(username: 'Kenny', password: "test", acct_type: "player", total_points: 0)
User.create(username: 'Kyle', password: "test", acct_type: "player", total_points: 3)
User.create(username: 'Lucy', password: "test", acct_type: "player", total_points: 43)
User.create(username: 'Nisa', password: "test", acct_type: "player", total_points: 11)
User.create(username: 'Ryan', password: "test", acct_type: "player", total_points: 10)
User.create(username: 'Shevon', password: "test", acct_type: "player", total_points: 9)
User.create(username: 'Terry', password: "test", acct_type: "player", total_points: 8)
User.create(username: 'Zeus', password: "test", acct_type: "player", total_points: 8)
